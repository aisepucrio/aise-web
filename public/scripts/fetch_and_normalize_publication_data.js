/**
 * fetch_and_normalize_publication_data.js
 * Script para buscar e normalizar dados de publications (SerpAPI)
 * ==========================================
 ...
 * O script busca o perfil do autor via SerpAPI, pagina resultados e salva em public/json/data/publications-data.json.
...
(async () => {
  try {
    ...
    const out = { publications_data: normalized };
    ...
    console.log(
      `OK: Normalizados ${normalized.length} publications (>${yearCutoff}) e salvos em ${filePath}`
    );
  } catch (err) {
