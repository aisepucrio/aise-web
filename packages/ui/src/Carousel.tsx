...
// Responsive carousel with auto-play, drag support, and navigation controls
export const Carousel: React.FC<CarouselProps> = ({
  ...
  const resolveWidth = (
    ...
    if (hasNumber) return { numeric: parsed, css: parsed };
  ...
  return (
    <MantineProvider>
      <Container
        ...
        px={16}
        style={{ maxWidth: isMobile ? "100%" : undefined, overflow: "hidden" }}
      >
        <Box
          ref={carouselRef}
          style={{
