...
```
name | position | imageUrl | description | email | researchInterests | technologies | knowledge | lattes | personalWebsite | linkedin | github | googleScholar | orcid
```

#### **IMPORTANTE: Linha 2 (Dados de Exemplo)**

A **linha 2** deve conter dados de exemplo/mockados que serão usados como template. Exemplo:

| name            | position              | imageUrl                 | description                     | email               | researchInterests        | technologies       | knowledge         | ... |
| --------------- | --------------------- | ------------------------ | ------------------------------- | ------------------- | ------------------------ | ------------------ | ----------------- | --- |
...
```json
{
  ...
  "Knowledge": ["Backend", "Frontend", "Data Science"]
}
```
...
**Não edite ou delete as linhas 1 e 2!**
