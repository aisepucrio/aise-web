...
Todos os textos, listas e dados que preenchem o site ficam em arquivos JSON dentro de `public/json` (por exemplo `data/tools-data.json`, `data/team-data.json`, `home.json`). Esses arquivos são a fonte da estrutura do website e podem ser editados diretamente para alterar conteúdo.
